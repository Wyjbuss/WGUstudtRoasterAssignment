...
Student::Student()
{
	...
	age = -1;
	numDaysToCompleteEachCourse[0,0,0];
	...
	int NnumDaysToCompleteEachCourse[])
{
	...
	degreeProgram = NdegreeProgram;
	age = Nage;
	numDaysToCompleteEachCourse[0] = NnumDaysToCompleteEachCourse[0];
	numDaysToCompleteEachCourse[1] = NnumDaysToCompleteEachCourse[1];
...
{
	std::cout << *numDaysToCompleteEachCourse;
